...
<TABLE class=field>
  <TBODY>
  <TR>
    <TD class=field>标　　题:<input type="hidden" class=text name="id" value="${house.id}"></TD>
...
name=floorage value="${house.floorage}"></TD></TR>
  ...
  <TR>
    ...
    <TD><INPUT class=text type=date name=pubdate value="
    <f:formatDate value="${house.pubdate}" pattern="yyyy-MM-dd"></f:formatDate>
    "></TD></TR>
  <TR>
  ...
  <TD><input type="hidden" value="${house.path}" name="oldFile">
    <img src="http://localhost:80/${house.path}"><br>
    <INPUT id=mfile type=file name=mfile ></TD></TR></TBODY></TABLE>
<DIV class=buttons><INPUT name="sum" value=立即修改 type=submit><br>
  <a href="showHouse">返回</a>
